...
<html>
    ...
    <body style="background-color: #000000">
        ...
        <div class="container">
            <form action="./BookAction.do" method="get">
                    ...
                    <div class='panel panel-default' style="background-color: #fff4ed;">
                        ...
                        <div class='panel-body' style="width: 90%;"> 
                            ...
                            <div class='panel-body' style="width: 90%; float: center;"> 
                                ...
                                <c:forEach  begin="1" end="${sessionScope.numberbk}" varStatus="loop">
                                    <tr>
                            ...
                            <input type="hidden" name="bkcount" value="${sessionScope.numberbk}" />
                            <br/>
